  ...
  return (
    <section className="py-16 md:py-24 overflow-hidden" ref={containerRef}>
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold mb-12 text-center">Brands We Carry</h2>

        <motion.div style={{ opacity, y }} className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-8 md:gap-12">
